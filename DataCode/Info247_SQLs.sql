...
update week3 set name = 'L4 Quiz 1: Constraints' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_1_constraints';
update week3 set name = 'L4 Quiz 2: Constraint Graphs' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_2_constraint_graph';
update week3 set name = 'L4 Quiz 3: Constraints' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_3_constraints';
update week3 set name = 'L4 Quiz 4: Backtracking Search' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_4_backtracking';
update week3 set name = 'L4 Quiz 5: Forward Checking' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_5_forward_checking';
update week3 set name = 'L4 Quiz 6: Arc Consistency' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_6_consistency';
update week3 set name = 'L4 Quiz 7: Arc Consistency' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_7_arc_consistency';
update week3 set name = 'L4 Quiz 8: Arc Consistency and Backtracking Search' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_8_arc_consistency_backtracking';
update week3 set name = 'L4 Quiz 9: Least Constraining Value' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_4:quiz_910_lcv';
update week3 set name = 'L5 Quiz 1: Tree-Structured CSPs' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_5:quiz_1_tree';
update week3 set name = 'L5 Quiz 2: Smallest Cutset' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_5:quiz_2_cutset';
update week3 set name = 'L5 Quiz 3: Min-Conflicts' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_5:quiz_3_min';
update week3 set name = 'L5 Quiz 4: Hill Climbing' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/Lecture_5:quiz_4_hill';
update week3 set name = 'HW Q1: Campus CSP' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/csp_campus';
update week3 set name = 'HW Q2: CSP Properties' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/csp_facts';
update week3 set name = 'HW Q3: 4-Queens' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/4_queens';
update week3 set name = 'HW Q4: Tree-Structured CSPs' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/csp_tree';
update week3 set name = 'HW Q5: Solving Tree-Structured CSPs' where module_id = 'i4x://BerkeleyX/CS188.1x/problem/csp_tree_solve';
...
update week3 set seqname ='HW Q1',seqlabel='HW Q1: Campus CSP' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Homework_2_CSPs' and position = 1;
update week3 set seqname ='HW Q2',seqlabel='HW Q2: CSP Properties' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Homework_2_CSPs' and position = 2;
update week3 set seqname ='HW Q3',seqlabel='HW Q3: 4-Queens' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Homework_2_CSPs' and position = 3;
update week3 set seqname ='HW Q4',seqlabel='HW Q4: Tree-Structured CSPs' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Homework_2_CSPs' and position = 4;
update week3 set seqname ='HW Q5',seqlabel='HW Q5: Solving Tree-Structured CSPs' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Homework_2_CSPs' and position = 5;
...
update week3 set seqname ='L4:Qz 1',seqlabel='L4 Quiz 1: Constraints' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs' and position = 4;
...
update week3 set seqname ='L4:Qz 2',seqlabel='L4 Quiz 2: Constraint Graphs' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs' and position = 6;
...
update week3 set seqname ='L4:Qz 3',seqlabel='L4 Quiz 3: Constraints' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs' and position = 8;
...
update week3 set seqname ='L4:Qz 4',seqlabel='L4 Quiz 4: Backtracking Search' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs' and position = 13;
update week3 set seqname ='L4 II:V10',seqlabel='L4 Part 10: Improving Backtracking: Overview' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 1;
update week3 set seqname ='L4 II:V11',seqlabel='L4 Part 11: Filtering: Forward Checking' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 2;
update week3 set seqname ='L4 II:Qz 5',seqlabel='L4 Quiz 5: Forward Checking' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 3;
update week3 set seqname ='L4 II:V12',seqlabel='L4 Part 12: Filtering: Constraint Propagation' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 4;
update week3 set seqname ='L4 II:V13',seqlabel='L4 Part 13: Consistency of a Single Arc' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 5;
update week3 set seqname ='L4 II:Qz 6',seqlabel='L4 Quiz 6: Arc Consistency' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 6;
update week3 set seqname ='L4 II:V14',seqlabel='L4 Part 14: Arc Consistency of an Entire CSP' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 7;
update week3 set seqname ='L4 II:Qz 7',seqlabel='L4 Quiz 7: Arc Consistency' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 8;
update week3 set seqname ='L4 II:V15',seqlabel='L4 Part 15: Limitations of Arc Consistency' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 9;
update week3 set seqname ='L4 II:Qz 8',seqlabel='L4 Quiz 8: Arc Consistency and Backtracking Search' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 10;
update week3 set seqname ='L4 II:V16',seqlabel='L4 Part 16: Demo of Forward Checking and Arc Consistency' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 11;
update week3 set seqname ='L4 II:V17',seqlabel='L4 Part 17: Variable Ordering: Minimum Remaining Values' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 12;
update week3 set seqname ='L4 II:V18',seqlabel='L4 Part 18: Value Ordering: Least Constraining Value' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 13;
update week3 set seqname ='L4 II:Qz 9',seqlabel='L4 Quiz 9: Least Constraining Value' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 14;
update week3 set seqname ='L4 II:V19',seqlabel='L4 Part 19: Demo' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_4_CSPs_continued' and position = 15;
...
update week3 set seqname ='L5:Qz 1',seqlabel='L5 Quiz 1: Tree-Structured CSPs' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II' and position = 6;
...
update week3 set seqname ='L5:Qz 2',seqlabel='L5 Quiz 2: Smallest Cutset' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II' and position = 10;
...
update week3 set seqname ='L5:Qz 3',seqlabel='L5 Quiz 3: Min-Conflicts' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II' and position = 13;
...
update week3 set seqname ='L5 II:V13',seqlabel='L5 Part 13: Local Search' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II_continued' and position = 1;
update week3 set seqname ='L5 II:V14',seqlabel='L5 Part 14: Hill Climbing' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II_continued' and position = 2;
update week3 set seqname ='L5 II:Qz 4',seqlabel='L5 Quiz 4: Hill Climbing' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II_continued' and position = 3;
update week3 set seqname ='L5 II:V15',seqlabel='L5 Part 15: Simulated Annealing' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II_continued' and position = 4;
update week3 set seqname ='L5 II:V16',seqlabel='L5 Part 16: Genetic Algorithms' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II_continued' and position = 5;
update week3 set seqname ='L5 II:V17',seqlabel='L5 Part 17: Next Time' where module_id = 'i4x://BerkeleyX/CS188.1x/sequential/Lecture_5_CSPs_II_continued' and position = 6;
